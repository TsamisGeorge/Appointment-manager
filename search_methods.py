...
class Search_methods():
    ...
    def add_info(self,tree_info):
        ...
        if tree_info==[]:
            list_info=showinfo(message="No Appointments at selected date!!")
    ...
    def print_appointment(self):
        ...
        if file_path:
            ...
            # Καθορισμός bold format
            bold=self.workbook.add_format({'bold':True})

            # Καθορισμός ονομάτων headers
            ...
            # Καθορισμός πλάτους(width) των στηλών
            ...
            # Εισαγωγή των στοιχείων στα κελιά
            row=1
            col=0
